"""
Combined seed data for the Adaptive Learning Platform.
Merges all courses from seed_data.py and seed_more_courses.py.
...
COURSES = [
    ...
    # ═══════════════════════════════════════════════════════════════════════
    # FROM seed_data.py — ORIGINAL 3 COURSES
    # ═══════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════
    # FROM seed_more_courses.py — 9 EXTENDED COURSES
    # ═══════════════════════════════════════════════════════════════════════
...
def run_seed(db) -> None:
    """
    Seed the database with all courses, lessons, quizzes, and questions.

    Safe to re-run: skips any course whose title already exists.
    The caller is responsible for managing the session (opening and closing).
    ...
    print("=" * 60)
    print(
        f"  Seeded  {total_courses} courses | {total_lessons} lessons | "
